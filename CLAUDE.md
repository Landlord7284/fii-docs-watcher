...
- **Timezone is fixed at `America/Sao_Paulo`**, independent of host or container, for "today", directory dates, retention frontier, index, and watermark. This is a property of the source, not a user setting (§5.8).
